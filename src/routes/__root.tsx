...
const gtmNoscriptIframe = `<iframe src="https://www.googletagmanager.com/ns.html?id=${GTM_ID}" height="0" width="0" style="display:none;visibility:hidden"></iframe>`;
...
function RootShell({ children }: { children: React.ReactNode }) {
  return (
    <html lang="ro">
      ...
      <body>
        <noscript dangerouslySetInnerHTML={{ __html: gtmNoscriptIframe }} />
        {children}
        <Scripts />
      </body>
    </html>
